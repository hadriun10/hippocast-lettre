...
// Fake letter content (1500 characters)
const FAKE_LETTER = `Madame, Monsieur,
...
export function LetterPreview({ onCopy, onDownload, isBlurred }: LetterPreviewProps) {
  ...
  return (
    <div className="w-full max-w-[750px] h-[530px] flex flex-col relative">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="154" height="154" viewBox="0 0 154 154" fill="none" className="w-80 h-80" style={{ stroke: 'black', strokeWidth: 1.5 }}>
      ...
      >
        {/* Letter box */}
        <div className="bg-white border-2 border-border rounded-xl p-6 flex-1 overflow-hidden flex flex-col" style={{ maxHeight: '420px' }}>
